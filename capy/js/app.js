...
const els={
  ...
  stashValueMini:$('stashValueMini'),stashValue:$('stashValue'),vorratNameMini:$('vorratNameMini'),vorratName:$('vorratName'),topUpAmount:$('topUpAmount'),coinRewardHint:$('coinRewardHint'),topUpButton:$('topUpButton'),
...
function renderWallet(){
  const coins=availableCoins(capy),stash=stashBalanceCents(plan,transactions),name=vorratName();els.coinCountTop.textContent=formatCoin(coins);els.coinCountShop.textContent=formatCoin(coins);els.stashValueMini.textContent=formatCents(stash);els.stashValue.textContent=formatCents(stash);els.vorratNameMini.textContent=name;els.vorratName.textContent=name;
}
function renderShop(){
