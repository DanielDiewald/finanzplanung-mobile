...
export function applyPet(care,behavior,overrideGain=null,overrideBondGain=null){const cfg=behavior.petting||behavior.interactions?.pet||{},gain=overrideGain==null?Number(cfg.happinessGain??cfg.happiness)||0:Number(overrideGain)||0,bondGain=overrideBondGain==null?Number(cfg.bondGain??cfg.bond)||0:Number(overrideBondGain)||0;care.happiness=clamp(care.happiness+gain);care.bond=clamp(care.bond+bondGain);return {happiness:gain,bond:bondGain};}
