...
export function renderSettings(settings,{capyEnabled=false,capyInitialized=false,capyName='',capyBudgetName=''}={}){
  ...
  if(name)name.textContent=capyInitialized?(capyBudgetName||globalThis.CapytCapyNaming?.budgetName(capyName||'Capy')||'Capy-Vorrat'):capyEnabled?'Capy auf diesem Gerät einrichten':'Am PC unter Grundlagen aktivieren';
